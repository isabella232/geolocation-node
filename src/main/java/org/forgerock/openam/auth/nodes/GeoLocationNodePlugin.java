...
public class GeoLocationNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(GeoLocationNodePlugin.currentVersion, 
				Collections.singletonList(GeoLocationNode.class));
	}
	...
	public String getPluginVersion() {
		return GeoLocationNodePlugin.currentVersion;
	}
}
